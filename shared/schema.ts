...
export const aiTerritoryContent = pgTable("ai_territory_content", {
  ...
  // Enriched cultural data fields
  kinshipSystem: text("kinship_system"),
  moietySystem: text("moiety_system"),
  skinNames: text("skin_names").array().default([]),
  traditionalGovernance: text("traditional_governance"),
  elderStructure: text("elder_structure"),
  environmentalKnowledge: text("environmental_knowledge"),
  landManagement: text("land_management"),
  waterKnowledge: text("water_knowledge"),
  tradeNetworks: text("trade_networks"),
  neighboringGroups: text("neighboring_groups").array().default([]),
  tradeGoods: text("trade_goods").array().default([]),
  musicInstruments: text("music_instruments").array().default([]),
  danceStyles: text("dance_styles").array().default([]),
  storytellingTraditions: text("storytelling_traditions"),
  toolsTechnology: text("tools_technology").array().default([]),
  weavingTextiles: text("weaving_textiles").array().default([]),
  significantSites: text("significant_sites").array().default([]),
  dreamtimeBeings: text("dreamtime_beings").array().default([]),
  contemporaryCulture: text("contemporary_culture"),
  languageRevival: text("language_revival"),
  culturalCentres: text("cultural_centres").array().default([]),
  notableFigures: text("notable_figures").array().default([]),
});
