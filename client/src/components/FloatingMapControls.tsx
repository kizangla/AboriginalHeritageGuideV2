              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-h-[400px] overflow-y-auto custom-scrollbar pr-2">
                {quickRegions.map((region) => (
                  <Button
                    ...
                    className={`h-11 text-sm flex items-center justify-between hover-lift ${selectedRegion === region.key ? 'bg-earth-orange hover:bg-earth-orange/90' : 'hover:bg-earth-beige'
                      }`}
                  >
